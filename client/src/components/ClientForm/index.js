...
class ClientForm extends Component {
    ...
    render() {
        ...
        return (
            <form className="col-md-8 m-3" onSubmit={e => onSubmit(e, mutation, form)}>
                <div className="form-row">
                    <div className="form-group col-md-6">
                        <label>Name</label>
                        <input type="text" className="form-control" placeholder="John" id="name" required value={form.name} onChange={e => this.onChange(e)}/>
                    </div>
                    <div className="form-group col-md-6">
                        <label>Last name</label>
                        <input type="text" className="form-control" placeholder="Doe" id="last_name" required value={form.last_name} onChange={e => this.onChange(e)}/>
                    </div>
                </div>
                <div className="form-row">
                    <div className="form-group col-md-12">
                        <label>Business</label>
                        <input type="text" className="form-control" placeholder="Business" id="business" value={form.business} onChange={e => this.onChange(e)}/>
                    </div>
                ...
                <div className="form-row">
                    <div className="form-group col-md-6">
                        <label>Age</label>
                        <input type="text" className="form-control" placeholder="Age" id="age" value={form.age} onChange={e => this.onChange(e)}/>
                    </div>
                    <div className="form-group col-md-6">
                        <label>Client type</label>  
                        <select className="form-control" id="type" required value={form.type} onChange={e => this.onChange(e)}>
                    ...
                    <button type="submit" className="btn btn-success float-right">{comingFromEdit ? 'Update client' : 'Add client'}</button>
            </form>
        );
    };
};
